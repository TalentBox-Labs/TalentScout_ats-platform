...
import { MapPin, Clock, DollarSign, Building, Users, Share2 } from 'lucide-react'

interface PublicJobContentProps {
  job: PublicJob
}

export function PublicJobContent({ job }: PublicJobContentProps) {
