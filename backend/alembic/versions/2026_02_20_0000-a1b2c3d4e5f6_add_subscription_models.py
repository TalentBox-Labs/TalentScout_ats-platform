...
def upgrade() -> None:
    ...
    op.create_table('subscriptions',
        ...
        sa.Column('plan', subscriptionplan, nullable=False, server_default=sa.text("'free'")),
        sa.Column('status', subscriptionstatus, nullable=False, server_default=sa.text("'trialing'")),
        sa.Column('payment_gateway', paymentgateway, nullable=True),
    ...
    op.create_table('payment_transactions',
        ...
        sa.Column('gateway', paymentgateway, nullable=False),
        ...
        sa.Column('status', transactionstatus, nullable=False, server_default=sa.text("'pending'")),
